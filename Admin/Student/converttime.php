...
if (isset($_POST['submit'])) {
    ...
    $font = 'arial.ttf';
      /*  imagestring($img, 50, 50, 50, $txt, $textcolor);*/
      imagettftext($img, 20, 0, 50, 50, $black, $font, $txt);
        ob_start();
        /*imagepng($img,'m.png');
         $save = $img .".png";
           imagepng($img, $save);*/
          $save = "../Student/images/Timetables/". $name .".png";
            imagepng($img, $save);
       /* printf('<img src="data:image/png;base64,%s"/ width="700">', base64_encode(ob_get_clean()));*/
